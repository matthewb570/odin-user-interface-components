...
class ImageCarousel {
  ...
  createSlideCollection() {
    ...
    this.images.forEach((image) =>
      divSlideCollection.appendChild(this.createSlide(image))
    );
    divSlideCollection.style.left = `${
      this.currentSlideIndex * -SLIDE_WIDTH
    }px`;
  ...
  displayNextSlide() {
    ...
    this.divSlideCollection.style.left = `${
      this.currentSlideIndex * -SLIDE_WIDTH
    }px`;
    this.setSelectedNavigationDot(this.currentSlideIndex);
  }
